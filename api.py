...
def get_project_list():
    ...
    filters = {}  # Default empty filter (for Task-Boss)

    if user_role == "Task-Lead":
        department_name = frappe.get_value("TaskEmployee", "department_name")
        filters["department"] = department_name  # Filter projects by lead's department
    elif user_role == "Task-Employee":
        filters["assigned_employee"] = user  # Show only projects assigned to the employee
